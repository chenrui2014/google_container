...
docker pull registry.cn-hangzhou.aliyuncs.com/google_containers/kube-cross:$KUBE_CROSS_VERSION
docker pull registry.cn-hangzhou.aliyuncs.com/google_containers/debian-base-amd64:$DEBIAN_BASE_VERSION
...
docker tag registry.cn-hangzhou.aliyuncs.com/google_containers/kube-cross:$KUBE_CROSS_VERSION k8s.gcr.io/kube-cross:$KUBE_CROSS_VERSION
docker tag registry.cn-hangzhou.aliyuncs.com/google_containers/debian-base-amd64:$DEBIAN_BASE_VERSION k8s.gcr.io/debian-base-amd64:$DEBIAN_BASE_VERSION
## 删除原镜像
...
docker rmi registry.cn-hangzhou.aliyuncs.com/google_containers/kube-cross:$KUBE_CROSS_VERSION
docker rmi registry.cn-hangzhou.aliyuncs.com/google_containers/debian-base-amd64:$DEBIAN_BASE_VERSION
